...
#include "Octagon.h"
#include "Point.h"
#include "/com.docker.devenvironments.code/src/lab0/Octagon.cpp"
...
TEST(constructor_test1_octagon, valid_data) {
...
TEST(constructor_test2_octagon, invalid_data) {
  Point<double> p1(10, 10);
  Point<double> p2(p1.get_x() - (1 + std::sqrt(2)), p1.get_y() + 1);
  Point<double> p3(p2.get_x() - 1, p2.get_y() + 1 + std::sqrt(2));
  Point<double> p4(p3.get_x() + 1, p3.get_y() + (1 + std::sqrt(2)));
...
TEST(calculate_centre_test_octagon, normal) {
  Point<double> p1(10, 10);
  Point<double> p2(p1.get_x() - (1 + std::sqrt(2)), p1.get_y() + 1);
  Point<double> p3(p2.get_x() - 1, p2.get_y() + 1 + std::sqrt(2));
  Point<double> p4(p3.get_x() + 1, p3.get_y() + (1 + std::sqrt(2)));
...
TEST(operator_double_test_octagon, normal) {
  Point<double> p1(10, 10);
  Point<double> p2(p1.get_x() - (1 + std::sqrt(2)), p1.get_y() + 1);
  Point<double> p3(p2.get_x() - 1, p2.get_y() + 1 + std::sqrt(2));
  Point<double> p4(p3.get_x() + 1, p3.get_y() + (1 + std::sqrt(2)));
...
TEST(compare_operator_test1_octagon, true_test) {
  Point<double> p1(10, 10);
  Point<double> p2(p1.get_x() - (1 + std::sqrt(2)), p1.get_y() + 1);
  Point<double> p3(p2.get_x() - 1, p2.get_y() + 1 + std::sqrt(2));
  Point<double> p4(p3.get_x() + 1, p3.get_y() + (1 + std::sqrt(2)));
...
TEST(compare_operator_test2_octagon, false_test) {
  Point<double> p1(1, 1);
  Point<double> p2(p1.get_x() - (1 + std::sqrt(2)), p1.get_y() + 1);
  Point<double> p3(p2.get_x() - 1, p2.get_y() + 1 + std::sqrt(2));
  Point<double> p4(p3.get_x() + 1, p3.get_y() + (1 + std::sqrt(2)));
