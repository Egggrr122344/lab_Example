...
TEST(constructor_test1_allocator, test_primitive) {
...
TEST(constructor_test2_allocator, test_non_primitive) {
...
TEST(copy_constructor_test1_allocator, test_primitive) {
...
TEST(copy_constructor_test2_allocator, test_non_primitive) {
...
TEST(allocate_test1, primitive_allocate_on_empty_vector) {
  mystd::allocator<int, 100> a;
...
TEST(allocate_test2, primitive_allocate_on_non_empty_vector) {
  mystd::allocator<int, 100> a;
