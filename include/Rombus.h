...
public:
    ...
    double CalculateArea() const override {
        ...
        double d1 = std::sqrt(std::pow(_points[0].x - _points[2].x, 2) + std::pow(_points[0].y - _points[2].y, 2));
        double d2 = std::sqrt(std::pow(_points[1].x - _points[3].x, 2) + std::pow(_points[1].y - _points[3].y, 2));
